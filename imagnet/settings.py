...
DATABASES = {
    'default': {
        ...
        'NAME': cur('imagnet.db'),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '2yq3ez*^3$f5gf125exvgnotz2^k$_gr!6v48$%1tgvx3&amp;sbtv'
...
WSGI_APPLICATION = 'imagnet.wsgi.application'
...
UPLOADCARE = {
    'pub_key': 'c3c4fdaa93bfb6087ff2',
    'secret': 'bf1eddbb30295afff3a6',
    }
